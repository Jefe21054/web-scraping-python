...
def check_price():
    while True:
        ...
        for product in products:
            ...
            new_ebay_price = ebay_soup.find('span', {'class':'ux-textspans'}).text
            ...
            if float(new_ebay_price[4:]) < float(new_amazon_price[5:]):
...
def init():
    ...
    if response == "y":
        ...
        amazon_result_url = f'https://www.amazon.com/s?k={name}&crid=1SIWV6DVTYIBV&sprefix={name}%2Caps%2C163&ref=nb_sb_noss_1'
